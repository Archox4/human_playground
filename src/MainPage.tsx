...
const MainPage = () => {
  ...
  return (
    <div className="flex flex-row flex-nowrap w-screen p-5 md:p-10">
      {games !== null && 
        <div className="flex flex-row w-full opacity-0 animate-fade-in" key={selectedGameId}>
          <div className="hidden xl:flex w-2/5 justify-start">
          ...
          {/* slider */}
          <div className="w-full xl:w-3/5 h-100 bg-dark-gray-1/60 rounded-2xl xl:mx-40 relative group">
